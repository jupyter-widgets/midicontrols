...
# -*- coding: utf-8 -*-
#
# ipymidicontrols documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipymidicontrols', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipymidicontrolsdoc'
...
latex_documents = [
    (master_doc, 'ipymidicontrols.tex', 'ipymidicontrols Documentation',
     'Project Jupyter Contributors', 'manual'),
]
